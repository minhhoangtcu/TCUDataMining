...
public class Iris {
	...
	public static void main(String args[]) throws Exception {
		...
		infoGain("data/iris_fil.csv");
		incrementalNB("data/iris_fil.csv");
		incrementalIBk("data/iris_fil.csv");
		drawROCCurve("data/iris_fil.csv");
	}
	...
	public static void incrementalNB(String dataset) throws Exception {
...
//			System.out.println("instance " + current);
		...
		// specify data source
		DataSource source = new DataSource("data/iris_fil_test.arff");
		// load the data
		Instances data = source.getDataSet();
	...
	public static void incrementalIBk(String dataset) throws Exception {
