...
public class Clustering {
	...
	public static void main(String args[]) throws Exception{
		...
		//load data
		Instances data = new Instances(new BufferedReader(new FileReader("data/bankSmall.arff")));
	...
	public static void clusterClassify() throws Exception{
		...
		for(int i = 0; i < dist.length; i++)	System.out.println("Cluster "+i+".\t"+cF.format(dist[i]));
	...
	public static void classifyByCluster() throws Exception{
		...
		// Cluster options 
		 data.setClassIndex(data.numAttributes() - 1);  // for the data read
		   String[] options = new String[2];
		   options[0] = "-W";
		   //options[1] = "weka.clusterers.SimpleKMeans";  // Simple K clusterdriver 4
